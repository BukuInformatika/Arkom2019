...
\input{chapters/DefinisidanSejarah}

\chapter{Kernel dan Perintah Dasar}
\input{chapters/KerneldanPerintahDasar}

\chapter{CPU}
\input{chapters/CPU}

\chapter{Memori}
\input{chapters/Memori}

\chapter{Komunikasi Hardware}
\input{chapters/KomunikasiHardware}

\chapter{Bilangan Komputasi}
\input{chapters/BilanganKomputasi}

\chapter{Standar}
\input{chapters/Standar}

\chapter{Serial Comm}
\input{chapters/SerialComm}

\chapter{Arduino}
\input{chapters/Arduino}

\chapter{Perintah Sederhana}
\input{chapters/PerintahSederhana}

\chapter{Feedback Sensor}
\input{chapters/FeedbackSensor}

\chapter{Membangun Alat}
\input{chapters/MembangunAlat}

\chapter{Aktuator}
\input{chapters/Aktuator}

\chapter{Instructables}
\input{chapters/Instructables}

\chapter{handrobotic}
\input{chapters/handrobotic}

\chapter{Line Follower Robotic}
\input{chapters/lfr}
